    ...
    <header className="fixed top-0 left-0 right-0 flex items-center justify-between max-w-7xl mx-auto backdrop-blur-sm bg-white/30 rounded-b-xl drop-shadow-md px-14 py-5">
      ...
      <ul className="font-unbounded font-light text-base flex items-center ">
        ...
        >
          ...
          {profDropDown && (
            <div className="profile-drown absolute top-20 right-0 rounded-xl bg-white p-2 pt-7 text-center">
              <span className="id font-nunito px-2 py-1 bg-indigo-200 rounded-md">
                ID: 23
              </span>
              <p className="p-2 my-2  border-b-2">John Doe</p>
              <p className="p-2 my-2  border-b-2">johndoe@gmail.com</p>
              <p className="flex items-center justify-center p-2 my-2 rounded-md text-red-500 cursor-pointer hover:bg-red-50 transition duration-150">
                <svg
                  viewBox="0 -0.5 25 25"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
