  ...
  return (
    <section className="h-dvh">
      <div className="login-container flex items-center justify-around h-full w-full">
        <div className="login-left shadow-2xl w-5/12 p-3 bg-primary dark:bg-white/10 dark:backdrop-blur-sm rounded-3xl text-center">
          <form
          ...
          <Link
            to={"/register"}
            className="block mx-auto my-5 w-3/5 px-3 py-3 text-lg cursor-pointer font-semibold bg-green-400  text-primary rounded-lg transition duration-300 hover:bg-green-500 hover:text-white active:bg-green-200  dark:bg-green-600 dark:hover:bg-green-500"
          >
            Register
          </Link>
        </div>
